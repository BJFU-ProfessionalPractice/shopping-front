  ...
  <div class="detail">
    ...
    <div class="container">
      ...
      <div class="product-detail-box">
        ...
        <p class="product-subtitle">{{product.productIntro}}</p>
        <p class="owner">小米自营</p>
        <p class="product-price">
          <span class="price-discount">{{product.productSellingPrice}}元</span>
          <span class="price" v-if="product.productPrice">{{product.productPrice}}元</span>
        </p>
        <!-- 地址 -->
...
<!--        </div>-->
        <div class="selected-box">
          <p class="product-info">
            ...
            <span class="price">{{product.productSellingPrice}}元</span>
          </p>
          <p class="total-price">总计：{{product.productSellingPrice}}元</p>
        </div>
...
import {getProductDetail, getUrl} from '../api'
...
export default {
  ...
  methods: {
    ...
    addToCart() {
      ...
      this.$axios({
        method: 'post',
        url: getUrl() + `/carts/${this.$store.state.username}/${this.id}`,
        contentType: 'application/x-www-form-urlencoded',
      }).then(() => {
          // 添加购物车成功
          this.$store.dispatch('saveCartCount',this.$store.state.cartCount+1);
